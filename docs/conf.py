...
module_dir = os.path.join(__location__, "../src/mesonic")
try:
...
try:
    from mesonic import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "mesonic Documentation", "Dennis Reinsch", "manual")
]
...
.. only:: html
    ...
    __ https://github.com/dreinsch/mesonic/blob/{{ env.config.release|e }}/{{ docpath }}
...
def extract_notebooks_from_doc(path, subdir, pattern="**/*.rst"):
...
def generate_notebook_links(notebooks_to_link, notebook_dir, nblinks_dir, media_dir):
...
def prepare_notebooks(notebooks_dir, media_dir, source, nblinks_dir):
    print("Preparing notebooks...")

    notebooks_to_link = extract_notebooks_from_doc(source, subdir=nblinks_dir)

    generate_notebook_links(
        notebooks_to_link=notebooks_to_link,
        notebook_dir=notebooks_dir,
        nblinks_dir=os.path.join(source, nblinks_dir),
        media_dir=media_dir,
    )
    print("Done preparing notebooks.")


notebooks_location = os.path.join(__location__, "../notebooks")
prepare_notebooks(
    notebooks_dir=notebooks_location,
    media_dir=os.path.join(notebooks_location, "files"),
    source=__location__,
    nblinks_dir="notebooks/",
)
